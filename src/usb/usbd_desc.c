...
#define USBD_MANUFACTURER_STRING   "Andy Best"


#define USBD_PRODUCT_HS_STRING        "Synthia MIDI Synthesizer (HS)"
#define USBD_SERIALNUMBER_HS_STRING   "00000000001A"
#define USBD_PRODUCT_FS_STRING        "Synthia MIDI Synthesizer (FS)"
